        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-body mb-6">
              At Apex Architects & Engineers, we believe that great design has the power to transform lives. For over 15 years, we've been creating spaces that inspire, function beautifully, and stand the test of time.
            </p>
